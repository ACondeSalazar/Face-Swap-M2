...
def main(
    ...
    generator='res_unet_split.MultiScaleResUNet(in_nc=101,out_nc=(3,3))',
    discriminator='discriminators_pix2pix.MultiscaleDiscriminator',
    seg_model=None, lms_model=None, seg_weight=0.1, rec_weight=1.0, gan_weight=0.001
):
...
if __name__ == "__main__":
    ...
    training.add_argument('-g', '--generator', default='res_unet_split.MultiScaleResUNet(in_nc=101,out_nc=(3,3))',
    ...
    training.add_argument('-sm', '--seg_model', default=None, metavar='PATH',
                          help='segmentation model')
    training.add_argument('-lm', '--lms_model', default=None, metavar='PATH',
                          help='landmarks model')
    training.add_argument('-sw', '--seg_weight', default=0.1, type=float, metavar='F',
    ...
    main(
        ...
        discriminator=args.discriminator, seg_model=args.seg_model, lms_model=args.lms_model,
