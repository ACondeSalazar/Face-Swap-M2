...
def main(
    ...
    # Data arguments
    train_dataset=' image_seg_dataset.ImageSegDataset', val_dataset=None, numpy_transforms=None,
    ...
    criterion='nn.CrossEntropyLoss', model=' models.simple_unet.UNet(n_classes=3,feature_scale=1)',
    pretrained=False, benchmark=' train_segmentation.IOUBenchmark(3)'
):
...
if __name__ == "__main__":
    ...
    data.add_argument('-td', '--train_dataset', default=' image_seg_dataset.ImageSegDataset',
    ...
    training.add_argument('-m', '--model', default=' models.simple_unet.UNet(n_classes=3,feature_scale=1)',
                          help='model object')
    training.add_argument('-p', '--pretrained', dest='pretrained', action='store_true',
                          help='use pre-trained model')
    training.add_argument('-be', '--benchmark', default=' train_segmentation.IOUBenchmark(3)',
