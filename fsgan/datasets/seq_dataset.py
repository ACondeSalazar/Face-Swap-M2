...
def main(dataset=' datasets.seq_dataset.SeqDataset', np_transforms=None,
    ...
    start = time.time()
    if isinstance(dataset,  datasets.seq_dataset.SeqPairDataset):
        for frame, landmarks, pose, target in dataloader:
            pass
    elif isinstance(dataset,  datasets.seq_dataset.SeqDataset):
