...
from  datasets.opencv_video_seq_dataset import VideoSeqPairDataset
from  datasets.img_landmarks_transforms import Crop, Resize, RandomHorizontalFlip, Pyramids, ToTensor
...
from  train_reenactment_attr import main
...
if __name__ == '__main__':
    ...
    main(exp_dir, train_dataset=train_dataset, val_dataset=val_dataset,
         ...
         generator=generator, discriminator=discriminator, seg_model=seg_model, lms_model=lms_model,
         seg_weight=seg_weight, rec_weight=rec_weight, gan_weight=gan_weight)
