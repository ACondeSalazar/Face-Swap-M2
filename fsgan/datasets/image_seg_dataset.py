...
def main(dataset=' datasets.image_seg_dataset.ImageSegDataset',
    ...
    from  utils.seg_utils import blend_seg_pred, blend_seg_label
...
if __name__ == "__main__":
    ...
    parser.add_argument('dataset', metavar='OBJ', default=' datasets.image_seg_dataset.ImageSegDataset',
                        help='dataset object')
