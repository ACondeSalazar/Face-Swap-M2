...
def main(
    ...
    lms_model=None, rec_weight=1.0, gan_weight=0.001
):
...
if __name__ == "__main__":
    ...
    import argparse
    parser = argparse.ArgumentParser('train_reenactment_attr_no_seg')
    ...
    main(
        ...
        discriminator=args.discriminator, lms_model=args.lms_model,
