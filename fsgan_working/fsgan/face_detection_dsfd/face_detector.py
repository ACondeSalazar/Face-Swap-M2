...
from fsgan.face_detection_dsfd.face_ssd_infer import SSD
from fsgan.face_detection_dsfd.data import widerface_640, TestBaseTransform
from fsgan.face_detection_dsfd.layers.functions.detection import Detect
...
class FaceDetector(object):
    def __init__(self, out_postfix='_dsfd.pkl', detection_model_path='weights/WIDERFace_DSFD_RES152.pth',
        ...
        # assert torch.cuda.is_available(), 'CUDA must be available!'  # COMMENTÉ pour permettre CPU
        ...
        self.net.load_state_dict(torch.load(detection_model_path, map_location=self.device))  # Ajout map_location
        self.net.eval()
